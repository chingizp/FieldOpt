...
class Case
{
 public:
  ...
  /*!
   * @brief Get the id vector specifying the ordering of the variables in the GetRealVarVector vector.
   * @return
   */
  QList<QUuid> GetRealVarIdVector() const { return real_id_index_map_; };
